...
class HeadlineArticlesViewControllerTests: XCTestCase {

    var sut: HeadlineArticlesViewController!
    var articles: [Article]!

    override func setUp() {
        super.setUp()
        let storyboard = UIStoryboard(name: "Articles", bundle: nil)
        self.sut = storyboard.instantiateViewController(withIdentifier: HeadlineArticlesViewController.storyboard_id) as! HeadlineArticlesViewController
